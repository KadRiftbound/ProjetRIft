...
const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition: 'Incliner une carte ou une rune à 90°. Marque qu\'elle a été utilisée ce tour. Les unités exhaussées ne peuvent pas attaquer.',
    category: 'mechanic'
  },
  {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 p-8 rounded-[32px] bg-gradient-to-br from-rift-gold/10 to-transparent border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-sm">
          ...
          <div className="flex gap-4">
            <Link href="/learn" className="px-8 py-4 bg-white text-black font-black rounded-2xl text-xs tracking-widest hover:scale-105 transition-all shadow-xl">
              APPRENDRE À JOUER
            </Link>
            <Link href="/deckbuilder" className="px-8 py-4 bg-rift-purple text-white font-black rounded-2xl text-xs tracking-widest hover:scale-105 transition-all shadow-xl">
              DECK BUILDER
            </Link>
          </div>
        </div>
