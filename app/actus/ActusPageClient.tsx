...
import { generateArticleJSON_LD } from '../lib/json-ld';
...
const CARD_ARTWORKS = [
  ...
  'https://cmsassets.rgpub.io/sanity/images/dsfx7636/game_data_live/8f2cf4d6c0bcf65e93f7f4cf2cc5b6d6a7bd8c1a-744x1039.png',
  'https://cmsassets.rgpub.io/sanity/images/dsfx7636/game_data_live/9a8c5d4e3b7cf76e84f6e5dd2bb4c5e7b8cd9a2b-744x1039.png',
];
...
export default function ActusPageClient() {
  const [apiNews] = useState<NewsItem[]>([]);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
            <span>📅</span> Dates de sortie à venir
          </h3>
